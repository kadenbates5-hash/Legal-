...
function emptySnapshot(): SystemStateSnapshot {
  return { version: 1, auditLog: [], utilization: { entries: [], nextId: 1 }, workProducts: [], deadlines: [], appointments: [] };
}
...
export async function loadSystemState(filePath: string, options?: LoadSystemStateOptions): Promise<SystemState> {
  ...
  return { auditLog, utilization, workProductStore, deadlineTracker, scheduling };
}
